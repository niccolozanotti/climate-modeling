\chapter{Models}
\lastupdated{2024-12-11}{\chapterFourOceanModOverleaf}
...
\begin{figure}[htp!]
	\centering
	\includegraphics[width=0.4\linewidth]{uploads/Screenshot 2024-11-22 000943.png}
...
\paragraph{Blackmon 1976.}\cite{Black76}  used spectral methods to decompose the variability of the 500 mbar geopotential height field into different spatial and temporal scales. He found:
\begin{itemize}
...
\paragraph{What do we do with climate models?}
\begin{enumerate}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.4\linewidth]{uploads/Screenshot 2024-11-22 202457.png}\quad \includegraphics[width=0.4\linewidth]{uploads/Screenshot 2024-11-24 185505.png}
