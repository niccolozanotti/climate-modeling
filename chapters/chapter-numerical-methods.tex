...
\lastupdated{2024-12-08}{\chapterThreeNumMeth}
...
\section{Models on the sphere/Spherical frame}\label{Sec:models on the sphere}
\begin{center}
...
The transform technique allows for relatively simple means of solving the equations. The essence of this technique is to transform from spectral space quantities to gripoint space quantities, then perform nonlinear products at each gridpoint, and to reverse quantities from gridpoint quantities back to spectral quantities.
