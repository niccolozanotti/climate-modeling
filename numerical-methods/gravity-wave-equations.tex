\chapter{The Gravity and Gravity-Inertia wave equations}\label{Chapter4}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic411.jpg}}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic412.jpg}}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic421.jpg}}
\caption{}
\end{figure}
...
% \begin{figure}
% \centering
% \includegraphics[width = .7 \textwidth]{./figs/GD/pic423.jpg}
% \caption{}
% \label{fig:}
% \end{figure}
...
% \begin{figure}
% \centering
% \pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic431.jpg}}
% \caption{}
% \end{figure}
...
% \begin{figure}
% \centering
% \pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic432.jpg}}
% \caption{}
% \end{figure}
...
% \begin{figure}
% \centering
% \pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic433.jpg}}
% \caption{}
% \end{figure}
...
The second value, \(\lambda = - 1\), represents a false computational
...
% \begin{figure}
% \centering
% \pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic441.jpg}}
% \caption{}
% \end{figure}
...
% \begin{figure}
% \centering
% \pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic442.jpg}}
% \caption{}
% \end{figure}
...
We shall discuss the properties of one of these "economical" schemes in
...
To understand this advantage of the forward-backward over the leapfrog
...
% \begin{figure}
% \centering
% \pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic461.jpg}}
% \caption{}
% \end{figure}
...
% \begin{figure}
% \centering
% \pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic462.jpg}}
% \caption{}
% \end{figure}
...
\section{The splitting or Marchuk
...
% \begin{figure}
% \centering
% \pandocbounded{\includegraphics[width = .7 \textwidth]{./pictest/pic481.jpg}}
% \caption{}
% \end{figure}
...
Shuman, F. G., 1974. Analysis and experiment in nonlinear computational
